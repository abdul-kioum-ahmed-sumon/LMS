            ...
            <div class="test">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" placeholder="Publication Date" name="Publication_Date">
                    </div>
                    ...
                    <div class="mt-3">
                        <div class="row">
                            ...
                            <div class="col">
                                <input class="btn btn-success" type="submit" value="Add Magazine" name="add" id="">
                            </div>
                ...
                if (isset($_POST['add']) && isset($_FILES['des'])) {
                    ...
                    $store = "mag_ass/" . $magazine;

                    move_uploaded_file($temp_location, $store);

                    $query_insert = "INSERT INTO `magazine`(`title`, `publisher`, `publication_date`, `category`, `language`, `ISSN_or_ISBN`, `description`)
     VALUES ('$title','$Publisher','$Publication_Date','$Category','$Language','$ISBN','$store')";
                    mysqli_query($conn, $query_insert);
                    $_SESSION['message'] = "Magazine added successfully";
