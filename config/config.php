...
// Document root & script directory
$document_root = rtrim($_SERVER['DOCUMENT_ROOT'], '/');
$script_dir = dirname(__DIR__);

// Detect environment
$host = $_SERVER['HTTP_HOST'];   // ← Automatically gets localhost or 10.10.0.55
$protocol = (!empty($_SERVER['HTTPS']) && $_SERVER['HTTPS'] !== 'off') ? "https" : "http";

// Dynamic base URL
define("BASE_URL", $protocol . "://" . $host . "/lms-master/");
define("DIR_URL", $document_root . "/lms-master/");
